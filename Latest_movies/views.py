...
# Extracting movie data from Rotten Tomatoes
    ...
    data = {'latest_movies': latest_movies}
...
#          'Release_Date': [movie[1] for movie in latest_movies],
    data = {'latest_movies': 'No data available at the moment. Please check back later.'}
...
if not latest_movies:
    ...
    exit(1)
def home(request):    
    print(data)  # Printing data for debugging purposes
